...
protected:
    ...
    /// @param error_code Error code to fill if the preprocessor returns an error
    ...
    virtual can_result_t _CanFramePostprocessor(CANObjectInterface &can_object, can_frame_t &outgoing_can_frame)
    {
        // No postprocessing needed for SET function
...
public:
    CANFunctionSet()
    {
        this->SetFunctionID(can_function_id_t::CAN_FUNC_SET_IN);
    }
};
